...
define(['frontend/app'], function (app) {
  ...
  return app.config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/new_fund', {templateUrl: 'wallet/new_fund.html', controller: 'NewFundCtrl'});
    $routeProvider.when('/new_pocket', {templateUrl: 'wallet/new_pocket.html', controller: 'PocketCreateCtrl'});
